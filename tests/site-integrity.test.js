...
test('mobile navigation has a visible label and keyboard escape handling', async () => {
  for (const name of ['index.html', 'learn.html', 'quiz.html', 'about.html', 'contact.html', 'privacy.html']) {
